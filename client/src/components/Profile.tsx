...
export default function Profile() {
  ...
  const iconUrls = [
    new URL('../assets/profile-icons/monster1.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster2.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster3.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster4.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster5.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster6.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster7.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster8.png', import.meta.url).href,
    new URL('../assets/profile-icons/monster9.png', import.meta.url).href,
  ]
