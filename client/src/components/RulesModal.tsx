...
function getRules(gameId?: string) {
  switch (gameId) {
    case 'card-calamity':
      return (
        <div className="space-y-3 text-sm text-slate-200">
          <p className="font-bold">Card Calamity — Rules (Detailed)</p>
          <div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li><strong>Calamity</strong> is an extremely rare special card (value +128). It can be played at any time and acts as a normal card for color/value matching, but scores as +128 if left in hand at game end.</li>
            </ul>
          </div>
          <div>
    ...
    case 'dubiously-patented':
      return (
        <div className="space-y-3 text-sm text-slate-200">
          <p className="font-bold">Dubiously Patented — Rules (Detailed)</p>
          <div>
            <p className="font-semibold">Overview</p>
    ...
    case 'nasty-libs':
      return (
        <div className="space-y-3 text-sm text-slate-200">
          <p className="font-bold">Nasty Libs — Rules (Detailed)</p>
          <div>
            <p className="font-semibold">Overview</p>
    ...
    case 'autism-assessment':
      return (
        <div className="space-y-3 text-sm text-slate-200">
          <p className="font-bold">Autism Assessment — Rules (Detailed)</p>
          <div>
            <p className="font-semibold">Overview</p>
